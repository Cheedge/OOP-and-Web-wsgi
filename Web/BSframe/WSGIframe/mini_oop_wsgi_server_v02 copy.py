"""
mini WSGI Server
version: 0.2 (with wsgi_app_frame_v02.py)
functionality:
...
class WSGI_SERVER(object):
    ...
    def request_handler(self, servant):
        ...
        # dynamic request
            ...
            environ = dict()
            request_body = wsgi_app_frame_v02.application(
                request_src_path, environ, self.set_response_head
                )
